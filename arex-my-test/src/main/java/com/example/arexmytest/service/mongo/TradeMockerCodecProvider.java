...
@Builder
public class TradeMockerCodecProvider implements CodecProvider {
    ...
    private volatile Codec<TradeMocker> arexMockerCodec;
    ...
    private Codec<TradeMocker> createCodec(CodecRegistry registry) {
        ...
        synchronized (this) {
            ...
            this.arexMockerCodec = new TradeMockerCodecImpl(classModel);
        }
        return this.arexMockerCodec;
    }
