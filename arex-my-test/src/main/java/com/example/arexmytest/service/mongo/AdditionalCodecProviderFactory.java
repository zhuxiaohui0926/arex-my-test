...
public class AdditionalCodecProviderFactory {
    ...
    private TradeMockerCodecProvider buildAREXMockerCodecProvider(MongoDatabase mongoDatabase) {
        ...
        return TradeMockerCodecProvider.builder().targetCodec(targetCompressionCodec).build();
    }
